...
{
    public class MegaConfig : MobiFlightBoardsConfig
    {

        public MegaConfig()
        {
            boardCapabilities = new MegaCapabilities();

            friendlyNameIdentifier = "Mega 2560";
            ...
            TYPE_ARDUINO = "Arduino Mega 2560";
